...
var countSubarrays = function (nums) {
      let n = nums.length;                            // Length of the nums array
      let ans = 0;                                    // Initialize answer to count valid subarrays

      for (let i = 1; i < n - 1; i++) {               // Iterate from index 1 to n-2 (middle elements)
