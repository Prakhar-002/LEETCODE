...
private:
      ...
      bool isSubIsland; // Flag to track if the current island in grid2 is a sub-island of grid1
...
public:
      int countSubIslands(vector<vector<int>>& grid1, vector<vector<int>>& grid2) {
            m = grid1.size(); // Number of rows in the grid
            n = grid1[0].size(); // Number of columns in the grid
