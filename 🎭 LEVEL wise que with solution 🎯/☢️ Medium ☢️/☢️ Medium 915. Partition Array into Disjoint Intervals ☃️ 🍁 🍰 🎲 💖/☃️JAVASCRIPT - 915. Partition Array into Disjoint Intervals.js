...
var partitionDisjoint = function (nums) {
      let curMax = nums[0];  // Tracks max value in the left partition
      let possibleMax = nums[0];  // Stores the overall max value encountered
      let length = 1;  // Stores partition size
